...
def test_core_shipment_remains_in_pipeline_until_lead_time(base_result):
    ...
    assert january_2036["gross_delivery_by_source"]["A"] == pytest.approx(10)
